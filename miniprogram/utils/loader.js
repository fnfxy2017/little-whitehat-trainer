...
const mainPackLevels = {
  T1: require('../levels/T1.json'),
  T2: require('../levels/T2.json'),
  T3: require('../levels/T3.json'),
  T4: require('../levels/T4.json'),
  T5: require('../levels/T5.json'),
  C1: require('../levels/C1.json'),
  C2: require('../levels/C2.json'),
  C3: require('../levels/C3.json')
};
